        ...
        <frame name='case-top' src='./casingborder.html' noresize scrolling='no'>										<!-- Casing: border top -->
            <frameset cols='3%,31%,*,31%,3%' border='10'>																
                ...
                <frameset rows='50%,50%' border='10'>
                    ...
                    <frame name='center-left-bottom' src='./puzzel1.html' noresize scrolling='no'>				        <!-- Casing: lower left corner / puzzle game 1 -->
                </frameset>
                <frameset rows='50%,50%' border='10'>
                    <frame name='center-middle-top' src='./puzzel4.html' noresize scrolling='no'>					<!-- Casing: center top / puzzle game 2 -->
                    <frame name='center-middle-bottom' src='./puzzel2.html' noresize scrolling='no'>				<!-- Casing: center bottom / puzzle frame 3 -->
                </frameset>
                <frameset rows='50%,50%' border='10'>
                    <frame name='center-right-top' src='./puzzel5.html' noresize scrolling='no'>					<!-- Casing: upper right corner / puzzle frame 4 -->
                    <frame name='center-right-bottom' src='./puzzel3.html' noresize scrolling='no'>				<!-- Casing: lower right corner / puzzle frame 5 -->
                </frameset>
